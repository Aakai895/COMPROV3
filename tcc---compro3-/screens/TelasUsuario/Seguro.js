      ...
      <View style={styles.contentArea}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.contentWrapper}>
            <Text style={styles.title}>Conheça Nosso Seguro</Text>
        ...
        <LinearGradient
          colors={[
            'rgba(109, 139, 137, 0.6)', 
            'rgba(109, 139, 137, 0.3)',
            'rgba(109, 139, 137, 0.0)' 
          ]}
          start={{ x: 0, y: 1 }}
          end={{ x: 0, y: 0 }}
        ...
        <Image
          source={require('../../assets/Plano_Fundo/MulherSeguro.png')}
